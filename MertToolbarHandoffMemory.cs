...
namespace MertsToolBox
{
    internal static class MertToolbarHandoffMemory
    {
        ...
        /// <summary>
        /// Attempts to resolve the parent menu entity from a given category entity.
        /// </summary>
        public static bool TryResolveMenuFromCategory(Entity categoryEntity, out Entity menuEntity)
        {
            ...
            if (entityManager.TryGetComponent(categoryEntity, out UIAssetCategoryData catData) &&
