...
namespace MertsToolBox
{
    public partial class GridToolSystem : MertBaseToolSystem
    {
        ...
        /// </summary>
        protected override bool RequiresSnapEnforcement => Mod.settings != null && Mod.settings.EnableGridSnap;
        #endregion
        ...
        /// <summary>
        /// Checks if the currently selected road prefab supports one-way patterns.
        /// </summary>
        public bool IsCurrentPrefabValidForOneWayPattern()
        {
            ...
            if (name.Contains("bridge") || name.Contains("quay") || name.Contains("pedestrian") || name.Contains("public transport") || name.Contains("alley") || name.Contains("gravel") || name.Contains("dirt") || name.Contains("roundabout"))
                return false;
